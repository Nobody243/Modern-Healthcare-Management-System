                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <div className="flex items-center gap-1.5 text-xs text-muted font-semibold shrink-0 pt-0.5">
                            ...
                            <span>{formatDate(surgery.SURG_DATE)}</span>
                          </div>
                        </div>

                        {/* Line 2: Reference No on left, Status Tag on right */}
                        <div className="flex items-center justify-between gap-2 mt-1.5">
                          <span className="table-id-link font-mono font-bold text-xs">
                            #{surgery.SURG_NUMBER}
                          </span>
                    ...
                    {surgery.SURG_DOC_NAME && (
                      <div className="mt-3.5 flex items-center justify-between text-xs text-muted pt-2.5 border-t border-border font-medium">
                        <span className="flex items-center gap-1.5">
                          ...
                          <span>Lead Surgeon: <span className="font-bold text-heading">{surgery.SURG_DOC_NAME}</span></span>
                        </span>
                      </div>
                    )}
                  </CardContent>
