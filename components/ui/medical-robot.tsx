...
export function MedicalRobot3D() {
  ...
  return (
    <div className="relative w-full h-[460px] sm:h-[520px] lg:h-[580px] flex items-center justify-center select-none">
      ...
      <div 
        className="absolute w-[360px] h-[360px] rounded-full blur-3xl pointer-events-none opacity-20"
        style={{
      ...
      <div className="absolute top-2 right-4 z-10 px-3.5 py-1 rounded-full bg-card/70 border border-border backdrop-blur-md text-[11px] font-mono text-primary flex items-center gap-2 pointer-events-none shadow-lg">
