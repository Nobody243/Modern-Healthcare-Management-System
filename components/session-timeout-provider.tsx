        ...
        {showWarning && !isPublicRoute && (
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-md bg-slate-900 border border-amber-500/30 rounded-2xl shadow-2xl overflow-hidden z-10"
            >
              ...
              <div className="p-6 space-y-5">
                ...
                <div className="flex items-start gap-4">
                  <div className="p-3.5 rounded-2xl bg-amber-500/10 border border-amber-500/25 text-amber-400 shrink-0 shadow-lg shadow-amber-500/10">
                    <ShieldAlert className="w-7 h-7 animate-pulse" />
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      <span className="text-[11px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-amber-500/15 text-amber-400 border border-amber-500/30">
                        Security Notice
                      </span>
                    </div>
                ...
                <div className="flex items-center justify-end gap-3 pt-3 border-t border-slate-800">
                  <Button
                    ...
                    className="bg-slate-800/60 hover:bg-slate-800 text-slate-300 border-slate-700 text-xs h-10 px-4 cursor-pointer gap-2"
                  >
                  ...
                  <Button
                    ...
                    disabled={isLoggingOut}
                    className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-semibold text-xs h-10 px-5 shadow-lg shadow-cyan-500/20 cursor-pointer flex items-center gap-2"
                  >
