  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white dark:bg-[#131f36] text-slate-900 dark:text-slate-100 border border-slate-200 dark:border-slate-700/80 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto"
      >
        <div className="sticky top-0 bg-white/95 dark:bg-[#131f36]/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-700/80 px-6 py-4 flex items-center justify-between z-10">
          ...
          <button
            onClick={onClose}
            className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-colors text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.status} onValueChange={(value) => setFormData({ ...formData, status: value })}>
                  ...
                  <SelectContent className="bg-white dark:bg-[#131f36] border-slate-200 dark:border-slate-700 text-slate-900 dark:text-slate-100">
                    ...
                    <SelectItem value="Expired" className="text-slate-900 dark:text-slate-100">Expired</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
          ...
          {/* Medication Details */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-slate-900 dark:text-slate-100 flex items-center gap-2 border-t border-slate-200 dark:border-slate-700/80 pt-4">
