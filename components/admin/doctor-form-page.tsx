          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="dept" className="text-sm font-bold text-slate-800 dark:text-slate-100 flex items-center gap-1.5">
                ...
                <div className="space-y-2">
                  <Label htmlFor="specialization" className="text-sm font-bold text-slate-800 dark:text-slate-100 flex items-center gap-1.5">
                ...
                <div className="space-y-2">
                  <Label htmlFor="status" className="text-sm font-bold text-slate-800 dark:text-slate-100 flex items-center gap-1.5">
                    <UserCog className="w-4 h-4 text-primary" />
                    Status
                  </Label>
                  <Input
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="password" className="text-sm font-bold text-slate-800 dark:text-slate-100 flex items-center gap-1.5">
